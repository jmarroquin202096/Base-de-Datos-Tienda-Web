...
CREATE TABLE IF NOT EXISTS  Pedidos(
	...
	Fecha DATE,
    TipoPedido_IdPedido INT NOT NULL,
    MetodoPago_IdMetodoPago INT NOT NULL,
    MontoTotal DECIMAL(10,2),
    Clientes_IdCliente INT NOT NULL,
    PRIMARY KEY (IdPedido),
    CONSTRAINT fk_Pedidos_TipoPedido
    FOREIGN KEY (TipoPedido_IdPedido) REFERENCES TipoPedido(IdPedido),
    CONSTRAINT fk_Pedidos_MetodoPago
    FOREIGN KEY (MetodoPago_IdPago) REFERENCES MetodoPago(IdPago),
